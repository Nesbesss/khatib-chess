...
set -e
cd "$(dirname "$0")"
APP="$HOME/Applications/Chess Engine.app"
...
swiftc -O -o "$MACOS/ChessEngine" Sources/Engine.swift Sources/main.swift \
...
<dict>
  ...
  <key>CFBundleIdentifier</key><string>local.chess.engine</string>
